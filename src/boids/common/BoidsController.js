...
export default class BoidsController {
    ...
    constructor(boundaryX = 500, boundaryY = 500, boundaryZ = 500, subDivisionCount=1) {
        ...
        // console.log(subDivisionCount, this.grid);
        this.flockEntities = [];
        ...
        this.maxEntitySpeed = 1.5;


        // was 100
        this.aligmentRadius = 10;
        this.cohesionRadius = 10;
        this.separationRadius = 13;
        this.obstacleRadius = 8;
